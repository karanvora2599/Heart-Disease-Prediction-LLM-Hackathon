...
path = '/content/Heart-Disease-Prediction-LLM-Hackathon/dataset/processed_inputs.csv'
df = pd.read_csv(path)
...
df_input =  pd.read_csv('/content/Heart-Disease-Prediction-LLM-Hackathon/dataset/inputs.csv')
df_outputs = pd.read_csv('/content/Heart-Disease-Prediction-LLM-Hackathon/dataset/labels.csv')
df = preprocess(df_input, df_outputs)
